...
const DateTimeDisplay = () => {
  ...
  return (
    <div className="bg-white p-4 rounded-lg max-w-2xl mt-20 max-h-[350px] ml-5 time">
      ...
      <div className="grid grid-cols-2 gap-3">
        {cities.map((city) => (
          <div
            key={city.name}
            className="bg-gray-50 p-2 rounded-md text-center text-sm border-2 border-cyan-400 w-[90px] h-[90px] mr-4 flex flex-col items-center justify-center"
          >
